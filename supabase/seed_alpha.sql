-- ============================================================
-- SEED DATA: INTERNAL ALPHA TEST DATASET (SUPABASE COMPLIANT)
...
-- ------------------------------------------------------------
-- 5. GENERATIONS & BRANCHES (Family Alpha)
-- ------------------------------------------------------------
...
('mb-a-003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-1', 'gen-a-2', 'Khang', 'Nguyễn Văn', 'Cụ Nguyễn Văn Khang (Trưởng Chi 1)', 'MALE', 'DECEASED', 1910, 18, 5, 1980, NULL, NULL),
('mb-a-004', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-2', 'gen-a-2', 'Ninh', 'Nguyễn Văn', 'Cụ Nguyễn Văn Ninh (Trưởng Chi 2)', 'MALE', 'DECEASED', 1913, 22, 11, 1985, NULL, NULL),
('mb-a-005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-3', 'gen-a-2', 'Thịnh', 'Nguyễn Văn', 'Cụ Nguyễn Văn Thịnh (Trưởng Chi 3)', 'MALE', 'DECEASED', 1916, 5, 4, 1990, NULL, NULL),
('mb-a-006', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-1', 'gen-a-3', 'Trọng', 'Nguyễn Văn', 'Ông Nguyễn Văn Trọng', 'MALE', 'DECEASED', 1940, NULL, NULL, NULL, NULL, NULL),
('mb-a-007', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-1', 'gen-a-4', 'Hoàng', 'Nguyễn Văn', 'Nguyễn Văn Hoàng (Trưởng Họ)', 'MALE', 'ALIVE', 1975, NULL, NULL, NULL, NULL, NULL),
('mb-a-008', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'br-a-1', 'gen-a-5', 'Nam', 'Nguyễn Văn', 'Nguyễn Văn Nam (Cháu đích tôn)', 'MALE', 'ALIVE', 2005, NULL, NULL, NULL, NULL, NULL)
ON CONFLICT (id) DO NOTHING;
