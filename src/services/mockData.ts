...
export const mockFamily: Family = {
  ...
  logo_url: 'https://images.unsplash.com/photo-1599839575945-a9e5af0c3fa5?w=150',
  banner_url: 'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=1600&auto=format&fit=crop',
  covenant_title: 'Hương Ước & Tộc Quy Đại Tộc Nguyễn Văn',
  covenant_preamble: 'Cây có cội mới trổ cành xanh lá, nước có nguồn mới biển rộng sông sâu. Người có tổ tông, ơn sinh thành dưỡng dục tựa biển trời. Bản Tộc ước được lập ra nhằm răn dạy con cháu giữ gìn gia phong, phát huy truyền thống hiếu học, đoàn kết tương thân tương ái, muôn đời hưng thịnh.',
  covenant_articles: [
...
export const mockMembers: Member[] = [
  // --- ĐỜI 1: THỦY TỔ ---
  {
    ...
    birth_time: 'Giờ Dần (03h - 05h)',
    courtesy_name: 'Húy: Phúc, Tự: Minh Đức, Hiệu: Tùng Hiên, Thụy: Ôn Nhã Tiên Sinh',
    death_lunar_day: 15,
    death_lunar_month: 8,
    death_lunar_year: 1912,
    death_time: 'Giờ Tý (23h15)',
  ...
  // --- ĐỜI 2: CÁC CHI CÀNH ---
  {
    ...
    branch_id: 'br-1',
    father_id: 'mb-001',
    birth_order: 1, // Con trưởng -> Chi Trưởng
    branch_code: 'root-c1-c1',
    branch_path: 'root.c1.c1',
    is_direct_lineage: true,
    first_name: 'Trọng',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Trọng (Cụ Khởi Tổ Chi Trưởng)',
    gender: 'MALE',
    life_status: 'DECEASED',
    birth_lunar_year: 1872,
    birth_time: 'Giờ Thìn (07h - 09h)',
    courtesy_name: 'Húy: Trọng, Tự: Chí Thành, Hiệu: Đoan Nghi',
    death_lunar_day: 10,
    death_lunar_month: 3,
    death_lunar_year: 1945,
    death_time: 'Giờ Hợi (21h30)',
  ...
  },
  {
    ...
    branch_id: 'br-2',
    father_id: 'mb-001',
    birth_order: 2, // Con thứ hai -> Chi Hai
    branch_code: 'root-c1-c2',
    branch_path: 'root.c1.c2',
    is_direct_lineage: false,
    first_name: 'Tín',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Tín (Cụ Khởi Tổ Chi Hai)',
    gender: 'MALE',
    life_status: 'DECEASED',
    birth_lunar_year: 1875,
    birth_time: 'Giờ Tỵ (09h - 11h)',
    courtesy_name: 'Húy: Tín, Tự: Nghĩa Trực, Hiệu: Trúc Phong',
    death_lunar_day: 20,
    death_lunar_month: 5,
    death_lunar_year: 1948,
    death_time: 'Giờ Ngọ (11h45)',
    burial_place: 'Nghĩa trang họ Nguyễn',
    bio: 'Cụ tổ khởi lập Chi Hai họ Nguyễn Văn.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  {
    ...
    father_id: 'mb-001',
    birth_order: 3,
    branch_code: 'root-c1-c3',
    branch_path: 'root.c1.c3',
    is_direct_lineage: false,
    first_name: 'Loan',
    last_name: 'Nguyễn Thị',
    full_name: 'Nguyễn Thị Loan (Cụ Bà Cô Đời 2)',
    gender: 'FEMALE',
    life_status: 'DECEASED',
    birth_lunar_year: 1878,
    death_lunar_day: 12,
    death_lunar_month: 11,
    death_lunar_year: 1952,
    bio: 'Cụ cô đời thứ 2 họ Nguyễn Văn.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  ...
  // --- ĐỜI 3 ---
  {
    ...
    branch_id: 'br-1',
    father_id: 'mb-002',
    birth_order: 1, // Trưởng tộc đời 3
    branch_code: 'root-c1-c1-c1',
    branch_path: 'root.c1.c1.c1',
    is_direct_lineage: true,
    first_name: 'Hoàng',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Hoàng (Trưởng Tộc)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '1968-05-12',
    avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
    bio: 'Trưởng tộc đời thứ 3 họ Nguyễn Văn, phụ trách điều hành gia tộc và quản lý nhà thờ tổ.',
    hometown: 'P. Định Công, Q. Hoàng Mai, Hà Nội',
    current_residence: 'Số 18 Ngõ 42 Tổ 5, P. Định Công, Hoàng Mai, Hà Nội',
    occupation: 'Kỹ sư Xây dựng • Giám đốc Doanh nghiệp',
    work_status: 'WORKING',
    phone: '0988123456',
    education_level: 'Thạc sĩ Quản trị Kinh doanh (MBA)',
    social_links: {
      facebook: 'facebook.com/truongtoc.nguyenvan',
      zalo: '0988123456',
      email: 'truongtoc.nguyen@giaphaviet.vercel.app',
    },
    created_at: '2026-01-01T00:00:00Z',
  ...
  },
  {
    ...
    branch_id: 'br-1',
    father_id: 'mb-002',
    birth_order: 2, // Con thứ Chi Trưởng
    branch_code: 'root-c1-c1-c2',
    branch_path: 'root.c1.c1.c2',
    is_direct_lineage: false,
    first_name: 'Hùng',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Hùng (Chú Chi Trưởng)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '1972-08-15',
    bio: 'Ủy viên Ban Quản Trị Từ Đường.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  {
    ...
    branch_id: 'br-2',
    father_id: 'mb-005',
    birth_order: 1, // Trưởng Chi Hai
    branch_code: 'root-c1-c2-c1',
    branch_path: 'root.c1.c2.c1',
    is_direct_lineage: false,
    first_name: 'Bình',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Bình (Trưởng Chi Hai)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '1965-02-20',
    bio: 'Trưởng Chi Hai họ Nguyễn Văn.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  ...
  // --- ĐỜI 4 ---
  {
    ...
    branch_id: 'br-1',
    father_id: 'mb-003',
    birth_order: 1, // Đích tôn đời 4
    branch_code: 'root-c1-c1-c1-c1',
    branch_path: 'root.c1.c1.c1.c1',
    is_direct_lineage: true,
    first_name: 'Tuấn',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Tuấn (Đích Tôn Đời 4)',
    gender: 'MALE',
    life_status: 'ALIVE',
  ...
  },
  {
    ...
    father_id: 'mb-003',
    birth_order: 2,
    branch_code: 'root-c1-c1-c1-c2',
    branch_path: 'root.c1.c1.c1.c2',
    is_direct_lineage: false,
    first_name: 'Mai',
    last_name: 'Nguyễn Thị',
    ...
    gender: 'FEMALE',
    life_status: 'ALIVE',
    birth_solar_date: '1998-03-14',
    bio: 'Con gái thứ hai của Trưởng tộc.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  {
    ...
    father_id: 'mb-007',
    birth_order: 1,
    branch_code: 'root-c1-c1-c2-c1',
    branch_path: 'root.c1.c1.c2.c1',
    is_direct_lineage: false,
    first_name: 'Nam',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Nam (Con Chú Chi Trưởng)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '1997-11-05',
    bio: 'Thành viên Ban Khuyến học.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  {
    ...
    father_id: 'mb-008',
    birth_order: 1,
    branch_code: 'root-c1-c2-c1-c1',
    branch_path: 'root.c1.c2.c1.c1',
    is_direct_lineage: false,
    first_name: 'Đức',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn Đức (Con Chi Hai)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '1992-06-18',
    bio: 'Thành viên Chi Hai.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
  ...
  // --- ĐỜI 5 ---
  {
    ...
    father_id: 'mb-004',
    birth_order: 1,
    branch_code: 'root-c1-c1-c1-c1-c1',
    branch_path: 'root.c1.c1.c1.c1.c1',
    is_direct_lineage: true,
    first_name: 'An',
    last_name: 'Nguyễn Văn',
    full_name: 'Nguyễn Văn An (Cháu Đích Tôn Đời 5)',
    gender: 'MALE',
    life_status: 'ALIVE',
    birth_solar_date: '2022-01-15',
    bio: 'Hậu duệ đời thứ 5 họ Nguyễn Văn.',
    created_at: '2026-01-01T00:00:00Z',
    updated_at: '2026-08-24T00:00:00Z',
  },
];
...
export const mockRelationships: MemberRelationship[] = [
  { id: 'rel-1', family_id: 'fam-0000-0001', member_id: 'mb-001', related_member_id: 'mb-002', relationship: 'CHILD', is_direct_lineage: true },
  { id: 'rel-2', family_id: 'fam-0000-0001', member_id: 'mb-001', related_member_id: 'mb-005', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-3', family_id: 'fam-0000-0001', member_id: 'mb-001', related_member_id: 'mb-006', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-4', family_id: 'fam-0000-0001', member_id: 'mb-002', related_member_id: 'mb-003', relationship: 'CHILD', is_direct_lineage: true },
  { id: 'rel-5', family_id: 'fam-0000-0001', member_id: 'mb-002', related_member_id: 'mb-007', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-6', family_id: 'fam-0000-0001', member_id: 'mb-005', related_member_id: 'mb-008', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-7', family_id: 'fam-0000-0001', member_id: 'mb-003', related_member_id: 'mb-004', relationship: 'CHILD', is_direct_lineage: true },
  { id: 'rel-8', family_id: 'fam-0000-0001', member_id: 'mb-003', related_member_id: 'mb-009', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-9', family_id: 'fam-0000-0001', member_id: 'mb-007', related_member_id: 'mb-010', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-10', family_id: 'fam-0000-0001', member_id: 'mb-008', related_member_id: 'mb-011', relationship: 'CHILD', is_direct_lineage: false },
  { id: 'rel-11', family_id: 'fam-0000-0001', member_id: 'mb-004', related_member_id: 'mb-012', relationship: 'CHILD', is_direct_lineage: true },
];
...
export const mockMemorialDates: MemorialDate[] = [
  {
    ...
    family_id: 'fam-0000-0001',
    member_id: 'mb-001',
    title: 'Giỗ Cụ Thủy Tổ Nguyễn Văn Phúc (Đời 1)',
    lunar_day: 15,
    lunar_month: 8,
    is_leap_month: false,
  ...
  },
  {
    ...
    family_id: 'fam-0000-0001',
    member_id: 'mb-002',
    title: 'Giỗ Cụ Tổ Chi Trưởng Nguyễn Văn Trọng (Đời 2)',
    lunar_day: 10,
    lunar_month: 3,
    is_leap_month: false,
  ...
  },
  {
    ...
    family_id: 'fam-0000-0001',
    member_id: 'mb-003',
    title: 'Giỗ Cụ Bà Lê Thị Mai',
    lunar_day: 15,
    lunar_month: 6,
    is_leap_month: true,
    notes: 'Cụ mất vào tháng 6 nhuận năm Ất Tỵ 1965 (Hỗ trợ cúng lễ tháng nhuận)',
    next_solar_date: '2025-08-08',
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    id: 'mem-dt-4',
    family_id: 'fam-0000-0001',
    member_id: 'mb-004',
    title: 'Giỗ Cụ Tiền Hiền Nguyễn Văn Hùng',
    lunar_day: 30,
    lunar_month: 12,
    is_leap_month: false,
    notes: 'Ngày giỗ 30 tháng Chạp (Tất niên cuối năm)',
    next_solar_date: '2027-02-05',
    created_at: '2026-01-01T00:00:00Z',
  }
];
...
export const mockEvents: Event[] = [
  ...
  },
  {
    id: 'evt-002',
    family_id: 'fam-0000-0001',
    title: 'Lễ Trao Thưởng Quỹ Khuyến Học Năm Học 2025-2026',
    description: 'Khen thưởng các cháu đạt giải học sinh giỏi quốc gia và đỗ đại học.',
    event_type: 'LONGEVITY',
    scope: 'FAMILY',
    solar_date: '2026-08-30',
    solar_time: '09:00',
    lunar_day: 18,
    lunar_month: 7,
    lunar_year: 2026,
    location: 'Nhà văn hóa chi phái Định Công',
  ...
  },
  {
    id: 'evt-003',
    family_id: 'fam-0000-0001',
    title: 'Họp Hội Đồng Gia Tộc Rằm Tháng Giêng',
    description: 'Báo cáo tổng kết thu chi năm qua và thông qua kế hoạch tu bổ hậu cung từ đường.',
    event_type: 'FAMILY_MEETING',
    scope: 'FAMILY',
    solar_date: '2026-03-03',
    solar_time: '08:30',
    lunar_day: 15,
    lunar_month: 1,
    lunar_year: 2026,
